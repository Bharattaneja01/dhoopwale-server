...
import com.dhoopwale.model.Category;
import com.dhoopwale.model.Product;
import com.dhoopwale.repository.CategoryRepository;
...
public class ProductServiceImplementation implements ProductService{
	...
	public Product createProduct(CreateProductRequest req) {
		...
		if(secondLevel==null) {
			...
			secondLevelCategory.setParentCategory(secondLevel);
		...
		product.setDiscountPercent(req.getDiscounPercent());
